    ...
    <div class="nav-tabs-custom">
      ...
      <div class="tab-content">
        <div class="active tab-pane" id="staff">
          <div class="row">
          <div class="col-md-10">
					<h4 class="profil">Profiles  Account</h4><hr>
            ...
            <div class="form-group">
              ...
              <?php
          			echo Html::a('<i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit Profil', ['update', 'id'=>$model->ID_DOKTER], [
          				'class' => 'btn btn-default',
          				'data-toggle'=>"modal",
                        'data-target'=>"#myModal",
                        'data-title'=>"Update Profil User",
          				]);?> 
					    </div> 
					  </div>
        ...
        <div class="tab-pane" id="account">
          ...
          <div class="form-group">
					    <div class="col-sm-offset-4 col-sm-10">
              <?php 
          			echo Html::a('Update Username & Password', ['update-account', 'id'=>$model->ID_DOKTER], [
          				'class' => 'btn btn-default',
          				'data-toggle'=>"modal",
                        'data-target'=>"#myModal",
