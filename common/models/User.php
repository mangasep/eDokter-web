...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            ['role', 'in', 'range' => [self::ROLE_USER, self::ROLE_ADMIN, self::ROLE_DIREKTUR]],
        ];
    }
    ...
    public static function isUserDirektur($username)
    {
          if (static::findOne(['username' => $username, 'role' => self::ROLE_DIREKTUR])){
